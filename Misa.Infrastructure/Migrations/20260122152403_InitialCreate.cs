    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                .Annotation("Npgsql:Enum:scheduler_misfire_policy", "catchup,run_once,skip");
            ...
            migrationBuilder.CreateTable(
                name: "scheduler_frequency_types",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_scheduler_frequency_types", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_at_utc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTimeOffset(new DateTime(2026, 1, 22, 16, 24, 2, 650, DateTimeKind.Unspecified).AddTicks(5698), new TimeSpan(0, 1, 0, 0, 0)))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    misfire_policy = table.Column<ScheduleMisfirePolicy>(type: "scheduler_misfire_policy", nullable: false, defaultValue: ScheduleMisfirePolicy.Catchup),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_scheduler_scheduler_frequency_types_frequency_type_id",
                        column: x => x.frequency_type_id,
                        principalTable: "scheduler_frequency_types",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_scheduler_frequency_type_id",
                table: "scheduler",
