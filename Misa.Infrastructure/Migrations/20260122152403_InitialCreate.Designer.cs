...
namespace Misa.Infrastructure.Migrations
{
    ...
    [Migration("20260122152403_InitialCreate")]
            ...
            modelBuilder.Entity("Misa.Domain.Features.Entities.Features.Descriptions.Description", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2026, 1, 22, 16, 24, 2, 650, DateTimeKind.Unspecified).AddTicks(5698), new TimeSpan(0, 1, 0, 0, 0)))
                        .HasColumnName("created_at_utc");
