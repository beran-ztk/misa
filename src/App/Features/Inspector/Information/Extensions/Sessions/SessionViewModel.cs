...
namespace Misa.Ui.Avalonia.Features.Inspector.Information.Extensions.Sessions;

public partial class SessionViewModel(DetailInformationViewModel parent) : ViewModelBase
{
    private DetailInformationViewModel Parent { get; } = parent;
