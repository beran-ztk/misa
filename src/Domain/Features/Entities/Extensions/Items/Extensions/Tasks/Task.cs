...
public class Task
{
    ...
    public static Task Create(string title, TaskCategory category, Priority priority, DateTimeOffset createdAt)
    {
        var item = Item.Create(Workflow.Task, title, priority, createdAt);
