...
namespace Misa.Infrastructure.Migrations
{
    ...
    [Migration("20260216182658_UpdateJournalUserRs")]
    partial class UpdateJournalUserRs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "journal_system_type", new[] { "session" });
            ...
            modelBuilder.Entity("Misa.Domain.Features.Audit.Journal", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Misa.Domain.Features.Audit.JournalCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("JournalId", "Name")
                        .IsUnique();

                    b.ToTable("journal_categories", (string)null);
                });

            modelBuilder.Entity("Misa.Domain.Features.Audit.JournalEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<JournalSystemType?>("SystemType")
                        .HasColumnType("journal_system_type");
            ...
            modelBuilder.Entity("Misa.Domain.Features.Audit.Journal", b =>
                {
                    b.HasOne("Misa.Domain.Features.Users.User", "User")
                        .WithOne()
                        .HasForeignKey("Misa.Domain.Features.Audit.Journal", "UserId")
            ...
            modelBuilder.Entity("Misa.Domain.Features.Audit.JournalCategory", b =>
                {
                    b.HasOne("Misa.Domain.Features.Audit.Journal", null)
                        .WithMany("Categories")
